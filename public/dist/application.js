...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('emails');'use strict';
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('landingpages');'use strict';
// Use Applicaion configuration module to register a new module
...
angular.module('emails').run([
  ...
  function (Menus) {
    ...
    Menus.addSubMenuItem('topbar', 'emails', 'download', 'emails');  //		Menus.addSubMenuItem('topbar', 'emails', 'novo email', 'emails/create');
  }
]);'use strict';
//Setting up route
...
angular.module('landingpages').controller('LandingpagesController', [
  ...
  function ($scope, $http, $upload, $stateParams, $location, Authentication, Landingpages) {
    ...
    $scope.findOne = function () {
      ...
      $scope.landingpage = Landingpages.get({ landingpageId: $stateParams.landingpageId });
    };
    // Find existing Landingpage
    $scope.findByCategoria = function () {
      $scope.showImage = true;
      $scope.landingpage = Landingpages.get({ categoria: $stateParams.categoria });
    };
    // -----------------------------------------------------------------
